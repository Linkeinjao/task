...
def show_menu():
    menu_window = tk.Tk()
    menu_window.title("Nethergear Task App Version 1.09")

    global task_entry
    task_entry_label = tk.Label(menu_window, text="Task:")
    ...
    img = img.subsample(10)  # Afbeelding schaal. Hogere waarde is kleinere afbeelding.
    ...
    # Add text label
    text_label = tk.Label(menu_window, text="Nethergear Task App Version 1.09")
    text_label.grid(row=3, column=1, padx=5, pady=5, sticky="e")
